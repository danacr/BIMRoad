...
<div class="container">
    ...
    %>
    <br>
    <a href="admin_home.jsp">Admin Home</a>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="addmessage.jsp?receiver=<%=tempMessage.getSender() %>">Reply</a>  <a href="deleteMessage?id=<%=tempMessage.getId() %>">Delete</a></td>
                </tr>
                <%
                    }
                %>
